...
<div class="slider">
	<ul class="nav">
		<li class="active"><a href="homeA.php">Beranda</a></li>
	...
	<div class="fluid_container">
        <div class="camera_wrap camera_magenta_skin" id="camera_wrap_1">
        	 <div data-src="images/general1.png" >
                <div class="camera_caption fadeFromBottom"> </div>
            </div>
             <div  data-src="images/BPH1.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
             <div  data-src="images/AE1.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
			<div  data-src="images/BE1.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
           	<div  data-src="images/HE1.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
          	<div  data-src="images/HRD1.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
          	<div  data-src="images/PR.png" >
             	<div class="camera_caption fadeFromBottom"> </div>
            </div>
