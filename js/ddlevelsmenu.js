...
downarrowpointer: ["../images/top_nav_arrow.gif", 0,0], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: ["../images/arrow_submenu.gif", 0,0], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
...
addshimmy:function(target){
	var shim=(!window.opera)? document.createElement("iframe1") : document.createElement("div") //Opera 9.24 doesnt seem to support transparent IFRAMEs
