...
<div class="main style4">
 ...
 <td align=""><div class="body_right_caloninvestor">
			  <h4>Daftar Divisi Agriculture and Environment	</h4>
...
<table width="150%" border="0" cellspacing="0" cellpadding="0" class="lbox_contentbg">
		...
		<p>&nbsp;</p>
          ...
          <tr class="row1" onMouseOver="mouse_event(this, 'listrow_bg');" onMouseOut="mouse_event(this, 'row1');">
					  ...
					  <td width="20%" valign="top" class="hdr1" align="center">Jabatan</td>
		...
		$No=1;
       	$query = mysql_query("select * from keanggotaan where Jabatan like '%AE%' ORDER BY Jabatan DESC");   //melakukan query pada database
