...
<div class="slider">
	<ul class="nav">
		...
		<li class="active" ><a href="cara.php">Notulensi Rapat</a></li>
		<li><a href="about.php">Laporan Keuangan</a></li>		
		<li><a href="contact.php">Jadwal Kegiatan</a></li>
		<div class="clear"></div>
	</ul>
</div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="lbox_contentbg">
		...
		<p>&nbsp;</p>
          ...
          <tr class="row1" onMouseOver="mouse_event(this, 'listrow_bg');" onMouseOut="mouse_event(this, 'row1');">
					  ...
					  <td width="5%" valign="top" class="hdr1" align="center">Nama File</td>
                      <td width="20%" valign="top" class="hdr1" align="center">Tanggal Rapat</td>
					  <td width="20%" valign="top" class="hdr1" align="center">Agenda Rapat<a </td>
