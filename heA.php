...
<div class="main style4">
 ...
 <td align=""><div class="body_right_caloninvestor">
			  <h4>Daftar Divisi Health and Education</h4>
...
<table width="150%" border="0" cellspacing="0" cellpadding="0" class="lbox_contentbg">
		...
		$No=1;
       	$query = mysql_query("select * from keanggotaan where Jabatan like '%HE%' ORDER BY Jabatan DESC");   //melakukan query pada database
