...
<table>
		...
		include 'config.php';  //memanggil file config.php supaya terkoneksi dengan database
       	$query = mysql_query("select * from keanggotaan where ID_Anggota = 003");   //melakukan query pada database
 ...
 <td align=""><div class="body_right_viewprofile">             
        ...
        <form name="myform" action="edit.php" id="myform" method="post" enctype="multipart/form-data">
              ...
              <h4>Profil Sekretaris 1</h4>
<div class="form_div">
              <img src="images/IMG_20150513_150604.jpg" alt="Diardian Febiani" width="162" height="216">              
                  <div>
