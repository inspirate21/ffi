...
<html>
<head>
	<title>Contoh Simple Download File</title>
    <link rel="stylesheet" type="text/css" href="css/upload-download.css">
</head>
<body>

	<div id="container">
    	<div id="header">
    		<h1>Contoh Simple Download File</h1>
        	<span>Forum for Indonesia</span>
        </div>
